...
7. **WP-PPR-MIG-005G — full section matrix:** **Completed**. [WP-005G-A](WP-PPR-MIG-005G-A-full-section-projection.md) завершил persisted projection/rebuild, [WP-005G-B](WP-PPR-MIG-005G-B-full-section-report-api.md) — scoped read-only matrix/person API, а [WP-005G-C](WP-PPR-MIG-005G-C-full-section-matrix-ui.md) — полное расширение существующей matrix UI: все десять колонок, постоянная горизонтальная прокрутка, sticky employee column и безопасные карточные переходы. WP-005F-D не входит в этот пакет.
