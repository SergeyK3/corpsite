...
Для импортированных записей обучения действует отдельный staging-review workflow:
[WP-PPR-MIG-004A](WP-PPR-MIG-004A-training-staging-review-and-validity.md). Предложение
сотрудника по обучению рассматривается кадровиком и не применяется напрямую к канонической
карточке.
