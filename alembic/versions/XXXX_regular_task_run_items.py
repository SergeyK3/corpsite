...
def upgrade():
    op.create_table(
        ...
        sa.Column("run_id", sa.BigInteger(), sa.ForeignKey("regular_task_runs.run_id", ondelete="CASCADE"), nullable=False),
        sa.Column("regular_task_id", sa.BigInteger(), sa.ForeignKey("regular_tasks.regular_task_id", ondelete="CASCADE"), nullable=False),
