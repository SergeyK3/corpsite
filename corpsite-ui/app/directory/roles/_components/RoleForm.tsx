    ...
    <form onSubmit={handleSubmit} className="flex h-full flex-col bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50">
      <div className="flex items-start justify-between border-b border-zinc-200 dark:border-zinc-800 px-6 py-5">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Справочник ролей</p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-5">
        <div className="mx-auto flex w-full max-w-3xl flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="role_code" className="text-sm font-medium text-zinc-800 dark:text-zinc-200">
            ...
            <input
              ...
              spellCheck={false}
              disabled={saving}
              className="h-11 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900 px-4 py-2 text-sm text-zinc-900 dark:text-zinc-50 outline-none transition placeholder:text-zinc-600 focus:border-zinc-400 disabled:cursor-not-allowed disabled:opacity-60"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="role_name" className="text-sm font-medium text-zinc-800 dark:text-zinc-200">
          ...
          <label className="flex items-center gap-3 text-sm text-zinc-800 dark:text-zinc-200">
            <input
              ...
              disabled={saving}
              className="h-4 w-4 rounded border-zinc-300 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-900 disabled:cursor-not-allowed"
            />
            Активна
          </label>
        </div>
