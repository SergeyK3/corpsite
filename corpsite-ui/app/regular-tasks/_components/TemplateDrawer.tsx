  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto p-4 sm:p-6">
      ...
      <div
        ...
        className="relative z-10 flex w-full max-w-[920px] flex-col rounded-2xl border border-zinc-200 bg-white shadow-2xl max-h-[min(920px,calc(100vh-2rem))] min-h-0"
      >
        <div className="flex shrink-0 items-start justify-between gap-4 border-b border-zinc-200 px-6 py-5">
          <div className="min-w-0">
            <h2 id="template-drawer-title" className="truncate text-2xl font-semibold leading-tight text-zinc-900">
              {title}
            </h2>
