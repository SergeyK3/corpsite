"""HTTP adapter for PPR military service mutations (WP-PR-029)."""
...
def _to_response(result: PprApplicationResult) -> PprCommandMutationResponse:
    return PprCommandMutationResponse(
        ...
        section_code=SECTION_CODE_PPR_MILITARY,
...
def create_military_service_by_person(
    user_ctx: dict[str, Any],
    *,
    person_id: int,
    ...
    result = service.create_military_service(envelope)  # type: ignore[attr-defined]
    return _to_response(result)


def create_military_service_by_employee(
    user_ctx: dict[str, Any],
    *,
    employee_id: int,
    body: PprMilitaryServiceCreateRequest,
...
def void_military_service_by_person(
    user_ctx: dict[str, Any],
    *,
    person_id: int,
    record_id: int,
    ...
    result = service.void_military_service(envelope)  # type: ignore[attr-defined]
    return _to_response(result)


def void_military_service_by_employee(
    user_ctx: dict[str, Any],
    *,
    employee_id: int,
    record_id: int,
...
def supersede_military_service_by_person(
    user_ctx: dict[str, Any],
    *,
    person_id: int,
    record_id: int,
    ...
    result = service.supersede_military_service(envelope)  # type: ignore[attr-defined]
    return _to_response(result)


def supersede_military_service_by_employee(
    user_ctx: dict[str, Any],
    *,
    employee_id: int,
    record_id: int,
