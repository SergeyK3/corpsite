...
from app.ppr.read.additional_reader import load_person_additional_profile, load_person_status_facts, load_person_status_note_hint
...
class PprCompositeReadOrchestrator:
    ...
    def assemble(
        ...
        *,
        ...
        family = section_reader.load_family(
            resolved_person_id,
            include_superseded=include_superseded_void,
            include_voided=include_superseded_void,
        )
        ...
        military = section_reader.load_military(
            resolved_person_id,
            include_superseded=include_superseded_void,
            include_voided=include_superseded_void,
        )
        ...
        additional = PprAdditionalReadSlice(
            ...
            source_note_hint=load_person_status_note_hint(
                uow.connection, person_id=resolved_person_id, employee_id=identity_resolution.employee_id,
            ),
        )
    ...
    def assemble_summary(
        ...
        *,
        ...
        return PprCompositeSummary(
            ...
            military_active_count=len(composite.military.active),
