...
REASON_LABELS = {
    ...
    "GENERAL_MISSING_FIRST_NAME": "Не указано имя.",
    "GENERAL_MISSING_FULL_NAME": "Не заполнено полное имя.",
    "GENERAL_IIN_MISSING_OR_INVALID": "ИИН отсутствует или содержит не 12 цифр.",
    "CANONICAL_EDUCATION_ABSENT": "В личной карточке нет действующих записей об образовании.",
    "CANONICAL_TRAINING_ABSENT": "В личной карточке нет действующих записей об обучении.",
    "CANONICAL_CATEGORY_ABSENT": "В личной карточке нет сведений о квалификационной категории.",
    "CATEGORY_RECORD_INVALID": "Запись о квалификационной категории имеет неверный формат.",
    "CATEGORY_REQUIRES_MANUAL_REVIEW": "Запись о квалификационной категории требует ручной проверки.",
    "CATEGORY_MISSING_SPECIALTY": "В записи о квалификационной категории не указана специальность.",
    "CATEGORY_ASSIGNED_DATE_MISSING_OR_AMBIGUOUS": "Не указана или неоднозначна дата присвоения квалификационной категории.",
    "CATEGORY_AMBIGUOUS_VALUE": "В исходной записи указано несколько или неоднозначное значение категории.",
    "EDUCATION_IMPORT_PROFILE_ABSENT": "В выбранном import-профиле нет записей об образовании.",
    "EDUCATION_IMPORT_MISSING_INSTITUTION": "В записи об образовании не указано учебное заведение.",
    "EDUCATION_IMPORT_MISSING_SPECIALTY": "В записи об образовании не указана специальность.",
    "EDUCATION_IMPORT_MISSING_COMPLETED_AT": "В записи об образовании не указана дата окончания.",
    "EDUCATION_IMPORT_DATE_OR_VALUE_INVALID": "Дата окончания образования или значение поля не проходит действующую проверку.",
    "EDUCATION_IMPORT_REVIEW_PENDING": "Для выбранной импортной записи образования есть незавершённая проверка.",
    "EDUCATION_IMPORT_REVIEW_PENDING_AUTO_READY": "Запись образования заполнена и проходит проверку; незавершённая import-проверка сохранена в provenance.",
    "EDUCATION_IMPORT_REVIEW_REJECTED": "Выбранная импортная запись образования отклонена при проверке.",
    "EDUCATION_IMPORT_REVIEW_APPROVED": "Выбранная импортная запись образования подтверждена.",
    "EDUCATION_IMPORT_REQUIRED_FIELDS_VALID": "Поля образования из выбранного import-профиля заполнены и проходят проверку.",
    "TRAINING_IMPORT_PROFILE_ABSENT": "В выбранном import-профиле нет записей об обучении.",
    "TRAINING_IMPORT_MISSING_TITLE": "В записи об обучении не указано название курса.",
    "TRAINING_IMPORT_MISSING_COMPLETED_AT": "В записи об обучении не указана дата.",
    "TRAINING_IMPORT_MISSING_HOURS": "В записи об обучении не указано количество часов.",
    "TRAINING_IMPORT_HOURS_INVALID": "Количество часов обучения имеет неверный формат.",
    "TRAINING_IMPORT_DATE_OR_VALUE_INVALID": "Дата обучения или значение поля не проходит действующую проверку.",
    "TRAINING_IMPORT_REVIEW_PENDING": "Для выбранной импортной записи обучения есть незавершённая проверка.",
    "TRAINING_IMPORT_REVIEW_PENDING_AUTO_READY": "Запись обучения заполнена и проходит проверку; незавершённая import-проверка сохранена в provenance.",
    "TRAINING_IMPORT_REVIEW_REJECTED": "Выбранная импортная запись обучения отклонена при проверке.",
    "TRAINING_IMPORT_REVIEW_APPROVED": "Выбранная импортная запись обучения подтверждена.",
    "TRAINING_IMPORT_REQUIRED_FIELDS_VALID": "Поля обучения из выбранного import-профиля заполнены и проходят проверку.",
    "AWARDS_IMPORT_PROFILE_ABSENT": "В выбранном import-профиле нет записей о наградах.",
    "AWARDS_IMPORT_MISSING_TITLE": "В записи о награде не указано наименование.",
    "AWARDS_IMPORT_MISSING_DATE": "В записи о награде не указана дата.",
    "AWARDS_IMPORT_DATE_OR_VALUE_INVALID": "Дата награды или значение поля не проходит действующую проверку.",
    "AWARDS_IMPORT_REQUIRED_FIELDS_VALID": "Поля награды из выбранного import-профиля заполнены и проходят проверку.",
    "ACADEMIC_DEGREES_TITLES_IMPORT_PROFILE_ABSENT": "В выбранном import-профиле нет сведений об учёных степенях или званиях.",
    "ACADEMIC_DEGREES_TITLES_IMPORT_MISSING_LABEL": "В записи об учёной степени или звании не указано наименование.",
    "ACADEMIC_DEGREES_TITLES_IMPORT_MISSING_COMPLETED_AT": "В записи об учёной степени или звании не указана дата.",
    "ACADEMIC_DEGREES_TITLES_IMPORT_DATE_OR_VALUE_INVALID": "Дата учёной степени или звания не проходит действующую проверку.",
    "ACADEMIC_DEGREES_TITLES_IMPORT_REQUIRED_FIELDS_VALID": "Поля учёной степени или звания из выбранного import-профиля заполнены и проходят проверку.",
    "CANONICAL_RELATIVES_ABSENT": "В личной карточке нет действующих записей о родственниках.",
    "CANONICAL_MILITARY_ABSENT": "В личной карточке нет действующих военно-учётных сведений.",
    "CANONICAL_EMPLOYMENT_BIOGRAPHY_ABSENT": "В личной карточке нет действующих записей трудовой биографии.",
    "CANONICAL_FOREIGN_LANGUAGES_ABSENT": "В личной карточке нет сведений об иностранных языках.",
    "CANONICAL_AWARDS_ABSENT": "В личной карточке нет сведений о наградах.",
    "CANONICAL_ACADEMIC_DEGREES_TITLES_ABSENT": "В личной карточке нет сведений об учёных степенях и званиях.",
...
PRESENTATION_SECTIONS: tuple[dict[str, Any], ...] = (
    ...
    {"code": "category", "title": "Категория", "order": 40},
    {"code": "relatives", "title": "Родственники", "order": 50},
    {"code": "military", "title": "Воинский учёт", "order": 60},
    {"code": "foreign_languages", "title": "Знание иностранных языков", "order": 70},
    {"code": "additional", "title": "Примечание", "order": 80},
    {"code": "employment_biography", "title": "Трудовая биография", "order": 90},
    {"code": "employment_history", "title": "Трудовая деятельность", "order": 100},
    {"code": "awards", "title": "Награды", "order": 110},
    {"code": "academic_degrees_titles", "title": "Учёные степени и звания", "order": 120},
)
